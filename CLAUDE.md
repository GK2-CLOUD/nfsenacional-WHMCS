...
- Logo pequena é **ampliada** até a caixa, então o campo recomenda pelo menos 280 × 150 px para não serrilhar na impressão. E não muito mais: o TCPDF embute o **arquivo original** no PDF, não a versão reduzida — medido, trocar uma logo de 22 KB por uma de 420 KB levou o DANFS-e de 89 KB para 430 KB.
...
| Identificação e `Página i de N` | `PdfRenderer::numerarPaginas()`, **da segunda folha em diante** |
...
- **Identificação por página**: uma folha solta precisa se identificar. A linha traz número da NFS-e e chave de acesso, não só "2 de 2", e fica no vão entre o fim do conteúdo e o pé da moldura. **Não sai na primeira folha** — ela já se identifica pelo cabeçalho e pelo bloco da chave, e a linha só repetia o que estava logo acima.
